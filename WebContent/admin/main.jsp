...
<head>
    ...
    <link rel="stylesheet" href="${path }/style/pageStyle.css">
...
<div class="goods_list">
   ...
   <c:forEach items="${goodsAll }" var="goodsAll" varStatus="status">
   <ul class="list_goods_ul">
        <li>${status.index + 1 }</li>
        <li><img src="${path }/admin/images/goods/${goodsAll.image }"></li>
        <li>${goodsAll.name }</li>
        <li>${goodsAll.price }</li>
        <li><a href="${path }/GoodsEditUIServlet?id=${goodsAll.id}"><img class="img_icon" src="${path }/admin/images/edit_icon.png" alt=""></a></li>
        <li><a href="${path }/GoodsDelServlet?id=${goodsAll.id}"><img class="img_icon" src="${path }/admin/images/delete_icon.png" ></a></li>
    </ul>
   </c:forEach>
